...
```{r}
create_dataset <- function(raw_data, variables, variable_names, operators, undesired_company_endings, name_col = "Name", time_col = "Time"){
...
```{r}
variables <- c("OPERATOR_ID", "NAME", "LOCAL_DATETIME", "LOCATION_LATITUDE", "LOCATION_LONGITUDE")
...
```{r}
write_feather(dataset, paste0("../data/dataset_", Sys.Date(), ".feather"))
```
